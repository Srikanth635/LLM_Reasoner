...
# 5. Agent Node
def multiply_agent(state: State):
...
graph_builder.add_node("agent", multiply_agent)
...
multiplier_agent = create_react_agent(
    model="openai:gpt-4o-mini",
    tools=tools,
    prompt=(
            "You are a multiplication agent.\n\n"
            "INSTRUCTIONS:\n"
            "- Assist ONLY with math-related multiplication tasks\n"
